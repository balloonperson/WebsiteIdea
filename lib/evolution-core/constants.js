...
export const TASK_DIFFICULTY = Object.freeze({
  TRIVIAL: "trivial",
  EASY: "easy",
  MEDIUM: "medium",
  HARD: "hard",
...
export const ALL_TASK_DIFFICULTIES = Object.freeze(Object.values(TASK_DIFFICULTY));

// Where a TaskSpec came from. Distinct from generation_method on candidate
// solvers — this is about who/what wrote the task, not the solver.
export const TASK_ORIGIN = Object.freeze({
  OPTIMIZER_SUGGESTED: "optimizer-suggested",
  USER_ADDED: "user-added",
  MANUAL_SET: "manual-set",
  IMPORTED: "imported",
  REGRESSION_FROM_FAILURE: "regression-from-failure"
});

export const ALL_TASK_ORIGINS = Object.freeze(Object.values(TASK_ORIGIN));

// A task's role in sampling. Distinct from is_held_out (which the evolution
// engine's promotion gates read directly): role is the Task Lab's richer
// classification, kept in sync with is_held_out for the 'held-out' value.
...
export const ALL_TASK_ROLES = Object.freeze(Object.values(TASK_ROLE));

export const TASK_REVIEW_STATUS = Object.freeze({
  PENDING: "pending",
  APPROVED: "approved",
  REJECTED: "rejected"
});

export const ALL_TASK_REVIEW_STATUSES = Object.freeze(Object.values(TASK_REVIEW_STATUS));

export const TASK_FILE_SCOPE = Object.freeze({
  SINGLE: "single",
  MULTI: "multi"
});

export const ALL_TASK_FILE_SCOPES = Object.freeze(Object.values(TASK_FILE_SCOPE));
